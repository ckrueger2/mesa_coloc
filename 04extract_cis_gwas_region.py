...
def check_arg(args=None):
    ...
    parser.add_argument('--chrom', help='path to input file', required='True')
    parser.add_argument('--left', help='path to input file', required='True')
    parser.add_argument('--right', help='path to input file', required='True')
